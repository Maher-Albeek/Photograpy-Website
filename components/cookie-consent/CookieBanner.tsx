...
export default function CookieBanner() {
  const { acceptAll, rejectAll, openSettings, isBannerOpen } = useCookieConsent();
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-5 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
